...
public class Config {
    ...
    public static int LED_DISPLAY_WIDTH = 0; // in px
    public static int LED_DISPLAY_HEIGHT = 0; // in px for 16:9 resolution
    public static int VIRTUAL_DISPLAY_WIDTH = 0; // in px
    public static int VIRTUAL_DISPLAY_HEIGHT = 0; // in px for 16:9 resolution
